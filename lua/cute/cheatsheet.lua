...
local sections = {
  ...
  { "▸ C/C++ build — <leader>r", {
    { "rr / rs", "Build & run / this file only" },
    { "rb / rl", "Build only / re-run last" },
    { "rR / ri", "Run with args / stdin file" },
    { "rg / rp", "CMake configure / target" },
    { "ro / rz", "Debug↔Release / sanitizers" },
    { "rv / rf", "Standard / show settings" },
    { "rq / rc", "Errors (quickfix) / clean" },
    { "rn / rP", "Write .clangd / CMakeLists" },
    { "tt / tf", "ctest all / pick" },
    { "dR", "Build & debug (lldb)" },
    { "cS  ⌥o", "Switch source ↔ header" },
  } },
  { "▸ Test — <leader>t", {
